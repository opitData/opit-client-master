...
import AddAnotherCarForm from './AddAnotherCarForm';

function AddAnotherCar(props) {
    ...
    return (
        <>
            ...
            <Text style={styles.title}>
                {t(`${createUserParking}.addNewCarTitle`)}
            </Text>
            <AddAnotherCarForm
                {...props}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddAnotherCar);
